@extends('layouts.shop')
    @section('title', '注册')
     ...
     <form action="login.html" method="get" class="reg-login">
      ...
      <div class="lrBox">
       <div class="lrList"><input type="text" class="phone" nema="phone" placeholder="输入手机号码或者邮箱号" /></div>
       ...
       <div class="lrList"><input type="password" name="pwd1" placeholder="再次输入密码" /></div>
      </div><!--lrBox/-->
      <div class="lrSub">
