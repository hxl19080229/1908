...
@endforeach
 ...
 @endif
<form class="form-horizontal" role="form" action="{{url('admin/update/'.$arr->id)}}" method="post" enctype="multipart/form-data">
	@csrf
	<div class="form-group">
		<label for="firstname" class="col-sm-2 control-label">管理员修改</label>
		<div class="col-sm-8">
			<input type="text" class="form-control account" value="{{$arr->account}}" name="account" id="firstname" 
				   placeholder="请输入名字">
	...
	<div class="form-group">
		...
		<div class="col-sm-8">
			<input type="text" class="form-control phone" value="{{$arr->phone}}" name="phone" id="firstname" 
				   placeholder="请输入名字">
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-8">
			<input type="email" class="form-control email" value="{{$arr->email}}" name="email" id="firstname" 
				   placeholder="请输入名字">
